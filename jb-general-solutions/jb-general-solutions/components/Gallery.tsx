      ...
      <div className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-12 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          ...
          <p className="font-body text-sm text-steel md:max-w-xs">
            Photos from completed jobs are being added. Check back soon, or
            ask to see examples of recent work relevant to your project.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {categories.map((cat) => (
            <div
              key={cat}
              className="group relative flex aspect-[4/3] flex-col items-center justify-center gap-3 overflow-hidden rounded-sm border border-dashed border-brass/30 bg-charcoal transition-colors hover:border-brass/60"
            >
